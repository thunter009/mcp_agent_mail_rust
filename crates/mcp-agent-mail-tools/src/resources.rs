            ...
            tools: vec![
                ...
                ToolDirectoryEntry {
                    ...
                    summary: "Remove an agent from the active roster while preserving message history."
                        .to_string(),
                    use_when: "Ending an agent session without erasing its audit trail."
                        .to_string(),
                    related: vec!["register_agent".to_string(), "retire_agent".to_string()],
                    expected_frequency: "At the end of short-lived automated sessions."
                        .to_string(),
                    required_capabilities: vec!["identity".to_string()],
                ...
                ToolDirectoryEntry {
                    ...
                    expected_frequency: "When a retired identity returns to active work."
                        .to_string(),
                    required_capabilities: vec!["identity".to_string()],
                    usage_examples: vec![ToolUsageExample {
...
mod resource_shape_tests {
    ...
    #[test]
    fn agents_resource_omits_deregistered_agents() {
        with_serialized_resources(|| {
            run_async(|cx| async move {
                let ctx = McpContext::new(cx.clone(), 1);
                ...
                for key in ["agents", "retired_agents"] {
                    assert!(
                        roster[key]
                            .as_array()
                            .expect("agent roster")
