...
Headline counts:
- Tools: 48 total = 37 Python behavior-fixture tools + 5 Python-compatible description/focused-test tools + 6 Rust-native fixture-backed (updated 2026-08-27)
...
| fetch_topic | yes | focused | python-parity | tests/conformance/fixtures/tool_descriptions.json | Python description/schema parity plus focused DB coverage for topic, unread, reply, and cross-project sender semantics. |
...
- Documentation alignment now records 48 tools / 25 resources: 42 Python-compatible tools and 6 Rust-native extensions.
